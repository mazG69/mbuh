...
def helptexttospeech():
    helpTextToSpeech =   "╔══[ TEXT TO SPEECH ]" + "\n" + \
                         "╠ af : Afrikaans" + "\n" + \
                         "╠ sq : Albanian" + "\n" + \
                         "╠ ar : Arabic" + "\n" + \
                         "╠ hy : Armenian" + "\n" + \
    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                line.sendMessage(op.param1, "Halo {} tercyduk add iaa".format(str(line.getContact(op.param1).displayName)))
        if op.type == 13:
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    line.sendContact(to, "ue1e44f13de7e46d116bd67ee6696b038")
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "Benchmarking")
                    elapsed_time = time.time() - start
                    line.sendMessage(to,format(str(elapsed_time)))
                elif text.lower() == 'restart':
                    line.sendMessage(to, "Stay..")
                    ...
                    try:
                        arr = []
                        owner = "ue1e44f13de7e46d116bd67ee6696b038"
...
#==============================================================================#
                    ...
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        ...
                        try:
                            ...
                            line.sendMessage(msg.to, "Done To Clone. Dont use it to Criminal")
                        except:
                    ...
                    try:
                        ...
                        line.sendMessage(msg.to, "Anda Terjebak")
#==============================================================================#
                        ...
                        for mention in mentionees:
                            if lineMID in mention["M"]:
                                if settings["detectMention"] == True:
                                    ...
                                    line.sendMessage(to, "Dont Tag Me.. Its Annoying")
